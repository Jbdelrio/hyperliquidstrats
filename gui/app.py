...
from gui.tabs import llm_overlay, exchanges, orders, triggers, metarbitrage, arena, macro, live_radar
...
_TABS = [
    ...
    ("📡 Live",       "tab-live-radar",   live_radar),
]
...
live_radar.register_callbacks(app)
