    ...
    try:
        ...
        for c in r.json():
            ...
            if sym and sym not in stables and mc >= min_mktcap:
                coins.append({"symbol": sym, "mktcap": mc})
...
def scan_once() -> dict:
    ...
    for coin in universe:
        ...
        opportunities.append({
            ...
            "buy_venue": buy_venue, "buy_ask": buy_ask,
            "sell_venue": sell_venue, "sell_bid": sell_bid,
    ...
    # "net positif HONNÊTE" = net ≥ seuil ET non suspect (leurre exclu)
    positive = [o for o in opportunities if o["net_bps"] >= MIN_NET_BPS and not o["suspect"]]
